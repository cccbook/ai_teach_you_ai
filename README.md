...
| Language | Title |
|----------|-------|
| [English](en/README.md) | Let AI Teach You Modern AI -- Understanding gradient with micrograd, understanding LLMs with microgpt |
| [繁體中文](tw/README.md) | 讓 AI 教你現代 AI -- 用 micrograd 理解梯度，用 microgpt 理解大語言模型 |
